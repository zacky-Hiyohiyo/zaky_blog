...
export const siteConfig: SiteConfig = {
	title: "藍月なくる的小窝",
	subtitle: "Hiyo~Hiyo~",
	siteURL: "https://hiyori.fun/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "zacky_hiyohiyo", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "318950244", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "<span style='font-size: 0.9em;'>過ぎてゆく季節に</span><br>在悄悄逝去的季节里",
			// 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/zacky-Hiyohiyo",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/318950244?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "表情包网站",
					url: "https://zacky-hiyohiyo.github.io/hiyori.github.io/#",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://api.i-meto.com/meting/api?server=netease&type=song&id=1350447904", // Meting API 地址
	id: "1350447904", // 歌单ID
