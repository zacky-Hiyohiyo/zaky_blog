...
export const zh_CN: Translation = {
	...
	// 番剧页面
	[Key.animeTitle]: "過去 今 明日 笑顔のあなた",
	[Key.animeSubtitle]: "赤 青 黄色 白 黒 あたし",
	...
	// 404页面
	[Key.notFound]: "404",
	[Key.notFoundTitle]: "页面被偷偷吃掉了",
	[Key.notFoundDescription]: "该页面已迷失于深渊。",
	[Key.backToHome]: "返回首页",
